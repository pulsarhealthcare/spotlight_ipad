...
<section style="background:url(img/background.png);background-size:100% 100%;" id="slide_container">
            ...
            <h2>By prescribing Spotlight products, you can<br>
            deliver significant potential savings for the NHS<br>
            ...
            drugs usually within a therapeutic class<br>
            is generally appropriate where there is no<br>
            contra-indication and where there is<br>
